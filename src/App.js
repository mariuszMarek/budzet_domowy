...
export default function App() {
  ...
  return (
    ...
    <div className='bg-gray-200 min-h-screen w-full grid grid-cols-[auto_1fr_auto] grid-rows-[100px_1fr_100px]'>
      <BrowserRouter>
          ...
          <ul className='w-full bg-blue-200 rounded-md pt-2 pb-2 mt-8 shadow-lg h-min'>
            {wpisy
              ...
              .map((wpis) => {
                ...
                return (
                  <li className='flex justify-evenly' key={wpis.id_wpisu}>
      ...
      {/* boczne meny */}
      <div className='flex row-start-2 col-start-3 m-2 mt-4 bg-gray-100 border-r border-b border-gray-200 p-4 shadow-md text-gray-700 font-medium transition'></div>
      {/* stopak */}
